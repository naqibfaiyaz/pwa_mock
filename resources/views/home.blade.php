...
<div class="container" id="app">
    <div class="row front-row card-background-color">
        <div class="col">
            <img src="icons/Yasir-Azman.jpg" class="rounded-circle profile-img-backgroud" alt="Cinque Terre" width="40" height="40"> 
        ...
        <div class="row card-background-color justify-content-center card-padding">
            <div class="row modified-inside-card">
                <div class="col icon-padding">
                    <img class="center-icon-block" src="icons/flexiplan.png" alt="Cinque Terre" width="48" height="48">
                    <div class="icon-text center-icon-block">FlexiPlan</div>
                </div>
                <div class="col icon-padding">
                    <img class="center-icon-block" src="icons/buy-internet.png" alt="Cinque Terre" width="48" height="48">
                    <div class="icon-text center-icon-block">Buy Internet</div>
                </div>
                <div class="col icon-padding">
                    <img class="center-icon-block" src="icons/buy-talktime.png" alt="Cinque Terre" width="48" height="48"> 
                    <div class="icon-text center-icon-block">Buy Talktime</div>
                </div>
                <div class="col icon-padding">
                    <img class="center-icon-block" src="icons/recharge.png" alt="Cinque Terre" width="48" height="48"> 
